...
namespace("sm.cfg", function(exports) {
  return __extends(exports, {
    API_HOSTNAME: "localhost:4000",
    API_DOMAIN: "localhost:4000",
    SEARCH_DOMAIN: "api.sellsto.me/search",
    SITE_DOMAIN: "localhost:3001"
  });
});
...
namespace("sm.ctr", function(exports) {
  var AdListCollection, AdListCtr, AdModel, Collection, Controller, ModalCtr, Model, Router, SEARCH_DOMAIN, SearchCtr, SearchListCollection, UrlBuilder, View, _ref;
  ...
  SEARCH_DOMAIN = sm.cfg.SEARCH_DOMAIN;
  ...
  App = (function(_super) {
    ...
    App.prototype._initAutoloadClasses = function() {
      ...
      return $('.autoload').each(function(i, _el) {
        var data_class, el, id;
        try {
          el = $(_el);
          el.removeClass('autoload');
          new ui[el.data('class')]({
            el: _el
          });
        } catch (exc) {
          id = _el.id != null ? _el.id : 'undefined';
          data_class = _el['data-class'] != null ? _el['data-class'] : 'undefined';
